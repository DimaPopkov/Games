...
namespace WindowsFormsApp1
{
    public partial class GameInfoForm : Form
    {
        ...
        public GameInfoForm(Game _game)
        {
            game = _game;
            InitializeComponent();
            ...
            textBox1.Text = "Игра: " + game.name;
            label2.Tag = game.Silka;
            label3.Text = game.price.ToString() + "Р.";
            try
            {
